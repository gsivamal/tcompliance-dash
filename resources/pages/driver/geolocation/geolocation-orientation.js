...
function addPosition(position, heading, m, speed) {
  ...
  if (heading && speed) {
    markerEl.src = 'pages/driver/geolocation/data/geolocation_marker_heading.png';
  } else {
    markerEl.src = 'pages/driver/geolocation/data/geolocation_marker.png';
  }
}
...
client.open('GET', 'pages/driver/geolocation/data/geolocation-orientation.json');
